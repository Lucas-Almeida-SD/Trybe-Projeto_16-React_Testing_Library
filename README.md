...
[Link](http://lucas-almeida-sd.github.io/Trybe-Projeto_16-React_Testing_Library) para a página do projeto.
...
O objetivo deste projeto foi escrever testes para uma aplicação React. A aplicação foi desenvolvida pela __Trybe__,  ficando apenas os testes para serem desenvolvidos. No entanto, ao final dos requisitos, houve um pequeno desafio para ser realizado, no qual foi para desenvolver uma composição a parte da aplicação.
...
O que temos a seguir não são requisitos bônus - são ideias para você se aprofundar mais no projeto e **aprender mais!** Que tal trabalhar neles? 
